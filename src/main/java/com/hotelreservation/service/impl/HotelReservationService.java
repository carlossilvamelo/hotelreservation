...
public class HotelReservationService implements IHotelReservationService{
	...
	List<HotelServiceStrategy> hotelServiceList = Arrays
			.asList(ServiceFactory.getLakewookCalculator(),
					ServiceFactory.getBridgewoodService(),
					ServiceFactory.getRidgewoodService());
