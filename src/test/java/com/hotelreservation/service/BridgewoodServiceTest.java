...
public class BridgewoodServiceTest {

	private BridgewoodService bridgewoodService = ServiceFactory.getBridgewoodService();

	@Test
	public void calculatePriceTestShouldReturnRightPrice() {
		Double[] rightPrices = { 480.0, 280.0, 270.0 };
		...
		for (String input : inputs) {
			...
			hotels.add(bridgewoodService.calculatePrice(costumerType, dates));
		}
