...
public class RidgewoodServiceTest {
	private RidgewoodService ridgewoodService = ServiceFactory.getRidgewoodService();

	@Test
	public void calculatePriceTestShouldReturnRightPrice() {
		Double[] rightPrices = { 660.0, 520.0, 240.0 };
		...
		for (String input : inputs) {
			...
			hotels.add(ridgewoodService.calculatePrice(costumerType, dates));
		}
